...
var user = prompt('User what is your name?');
alert(user + ' I will be asking you a series of short questions based on my life, do your best!');
...
function questionOne() {
    ...
    alert('Sorry! ' + user + ' you are incorrect :( - Steak is gross! ');
    }
}
...
function questionTwo() {
    ...
    if(question2.toLowerCase() === 'y' || question2.toLowerCase() === 'yes' ) { //if input is equal to the string "Y" || "YES" make input lower case.
        ...
        alert('you are incorrect :( - you should know me better than that!');
    }
}
